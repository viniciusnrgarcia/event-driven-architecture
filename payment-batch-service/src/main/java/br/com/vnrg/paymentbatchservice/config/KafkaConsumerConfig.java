package br.com.vnrg.paymentbatchservice.config;
...
public class KafkaConsumerConfig {
    ...
    KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, String>> kafkaListenerContainerFactory() {
        ...
        // factory.setBatchListener(true); // habilita processamento batch
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(ConsumerConfig.MAX_POLL_RECORDS_CONFIG, "10"); // O numero máximo de eventos retornado em uma simples chamada de poll(). O valor default é 500.
