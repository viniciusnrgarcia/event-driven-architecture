...
public class PaymentRetryConsumer {
    ...
    @KafkaListener(id = "payment-batch-service-retry-id",
            topics = "payment-validated-retry", groupId = "payment-batch-service-retry-group", concurrency = "${listen.concurrency:1}",
